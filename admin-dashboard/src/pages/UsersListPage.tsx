...
export default function UsersListPage() {
  ...
  const fetchUsers = useCallback(
    async (nextCursor?: string | null) => {
      ...
      if (appliedFilters.entitlement_state)
        params.set('entitlement_state', appliedFilters.entitlement_state);
      if (appliedFilters.min_sessions)
        params.set('min_sessions', appliedFilters.min_sessions);
      if (appliedFilters.max_sessions)
        params.set('max_sessions', appliedFilters.max_sessions);
      ...
      <form onSubmit={handleFilterSubmit} style={styles.filtersForm}>
        <div style={styles.filtersRow}>
          <div style={styles.filterField}>
            <label htmlFor="filter-email" style={styles.filterLabel}>
              Email
            </label>
            <input
              id="filter-email"
          ...
          <div style={styles.filterField}>
            <label htmlFor="filter-role" style={styles.filterLabel}>
              Role
            </label>
            <select
              id="filter-role"
          ...
          <div style={styles.filterField}>
            <label htmlFor="filter-entitlement" style={styles.filterLabel}>
              Entitlement
            </label>
            <select
              id="filter-entitlement"
              value={filters.entitlement_state}
              onChange={(e) =>
                setFilters((f) => ({
                  ...f,
                  entitlement_state: e.target.value,
                }))
              }
              style={styles.filterInput}
            >
          ...
          <div style={styles.filterField}>
            <label htmlFor="filter-min-sessions" style={styles.filterLabel}>
              Min sessions
            </label>
            <input
              id="filter-min-sessions"
              type="number"
              min="0"
              placeholder="0"
              value={filters.min_sessions}
              onChange={(e) =>
                setFilters((f) => ({ ...f, min_sessions: e.target.value }))
              }
              style={styles.filterInput}
            />
          </div>
          ...
          <div style={styles.filterField}>
            <label htmlFor="filter-max-sessions" style={styles.filterLabel}>
              Max sessions
            </label>
            <input
              id="filter-max-sessions"
              type="number"
              min="0"
              placeholder="∞"
              value={filters.max_sessions}
              onChange={(e) =>
                setFilters((f) => ({ ...f, max_sessions: e.target.value }))
              }
              style={styles.filterInput}
            />
          </div>
